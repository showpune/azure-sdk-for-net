...
namespace Azure.ResourceManager.SpringAppDiscovery.Samples
{
    public partial class Sample_ErrorSummaryCollection
    {
        ...
        // ErrorSummaries_CreateOrUpdate_MaximumSet_Gen
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CreateOrUpdate_ErrorSummariesCreateOrUpdateMaximumSetGen()
        {
            // Generated from example definition: specification/offazurespringboot/resource-manager/Microsoft.OffAzureSpringBoot/preview/2023-01-01-preview/examples/ErrorSummaries_CreateOrUpdate_MaximumSet_Gen.json
            // this example is just showing the usage of "ErrorSummaries_CreateOrUpdate" operation, for the dependent resources, they will have to be created separately.
...
["key2085"] = "olljrx",
        ...
        // ErrorSummaries_CreateOrUpdate_MinimumSet_Gen
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CreateOrUpdate_ErrorSummariesCreateOrUpdateMinimumSetGen()
        {
            // Generated from example definition: specification/offazurespringboot/resource-manager/Microsoft.OffAzureSpringBoot/preview/2023-01-01-preview/examples/ErrorSummaries_CreateOrUpdate_MinimumSet_Gen.json
            // this example is just showing the usage of "ErrorSummaries_CreateOrUpdate" operation, for the dependent resources, they will have to be created separately.
