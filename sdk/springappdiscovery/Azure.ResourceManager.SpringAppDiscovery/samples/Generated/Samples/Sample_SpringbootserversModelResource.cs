...
namespace Azure.ResourceManager.SpringAppDiscovery.Samples
{
    public partial class Sample_SpringbootserversModelResource
    {
        ...
        public async Task Delete_SpringbootserversDeleteMaximumSetGen()
        {
            ...
            // invoke the operation
            ArmOperation<SpringbootserversModelResource> lro = await springbootserversModel.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task GetSpringbootserversModels_SpringbootserversListBySubscriptionMaximumSetGen()
        {
            ...
            await foreach (SpringbootserversModelResource item in subscriptionResource.GetSpringbootserversModelsAsync())
            {
