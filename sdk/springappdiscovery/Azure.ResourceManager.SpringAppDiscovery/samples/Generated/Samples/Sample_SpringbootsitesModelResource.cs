...
namespace Azure.ResourceManager.SpringAppDiscovery.Samples
{
    public partial class Sample_SpringbootsitesModelResource
    {
        ...
        public async Task Delete_SpringbootsitesDeleteMaximumSetGen()
        {
            ...
            // invoke the operation
            ArmOperation<SpringbootsitesModelResource> lro = await springbootsitesModel.DeleteAsync(WaitUntil.Completed);
...
["key9581"] = "cgdqvbknjrwcwuesquddsxu",
            ...
            SpringbootsitesModelResource result = await springbootsitesModel.UpdateAsync(patch);
