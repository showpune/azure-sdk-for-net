...
namespace Azure.ResourceManager.SpringAppDiscovery
{
    ...
    public partial class SummaryCollection : ArmCollection, IEnumerable<SummaryResource>, IAsyncEnumerable<SummaryResource>
    {
        ...
        public virtual async Task<ArmOperation<SummaryResource>> CreateOrUpdateAsync(WaitUntil waitUntil, SummaryData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _summaryRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, data, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<SummaryResource> CreateOrUpdate(WaitUntil waitUntil, SummaryData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                var response = _summaryRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, data, cancellationToken);
                var operation = new SpringAppDiscoveryArmOperation<SummaryResource>(Response.FromValue(new SummaryResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _summaryRestClient.CreateListBySiteRequest(Id.SubscriptionId, Id.ResourceGroupName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _summaryRestClient.CreateListBySiteNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _summaryRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _summaryRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
